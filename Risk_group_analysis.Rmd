...
With FDR= 0.05 and log2FoldChange > 1 or < -1, there are 433 differentially expressed genes. 
279 genes were enriched in the high-risk group and 154 genes were enriched in the low-risk group

```{r}
res05 <- results(dds_tumor, alpha=0.05) 
sum(res05$padj < 0.05 & res05$log2FoldChange>1, na.rm=TRUE) 
sum(res05$padj < 0.05 & res05$log2FoldChange<(-1), na.rm=TRUE) 
